...
<div id="footer__credits" class="footer__credits" <?php czr_fn_echo('element_attributes') ?>>
  ...
  <p class="czr-credits">
    <span class="czr-designer"><span class="czr-wp-powered"><span class="czr-wp-powered-text"><?php _e( 'Powered by', 'customizr') ?>&nbsp;</span><a class="czr-wp-powered-link fa fa-wordpress" title="<?php _e( 'Powered by WordPress', 'customizr' ) ?>" href="<?php echo esc_url( __( 'https://wordpress.org/', 'customizr' ) ); ?>" target="_blank"></a></span><span class="czr-designer-text">&nbsp;&ndash;&nbsp;<?php _e('Designed with', 'customizr') ?>&nbsp;<a class="czr-designer-link" href="<?php echo esc_url( CZR_WEBSITE . 'customizr' ); ?>" title="Press Customizr"><?php _e('the Customizr theme', 'customizr') ?></a></span></span>
  </p>
</div>
