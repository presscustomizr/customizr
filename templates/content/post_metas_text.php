...
<span class="pub-date"><?php echo tc_get( 'publication_date')  ?></span>
<?php endif; ?>
<?php if ( tc_get( 'cat_list' ) ) : ?>
 <span class="w-cat"><?php _e( 'in', 'customizr' ) ?> <?php echo tc_get( 'cat_list', array('/') ) ?></span>
<?php endif; ?>
<?php if ( tc_get( 'tag_list' ) ): ?>
 <span class="w-tags"><?php _e( 'tagged', 'customizr' ) ?> <?php echo tc_get( 'tag_list', array('/') ) ?></span>
<?php endif; ?>
