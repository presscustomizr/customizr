  ...
  <?php do_action( '__before_inner_attachment_content' ) ?>
    <div class="entry-attachment">
      <div class="attachment">
        <a href="<?php czr_echo( 'link_url' ) ?>" class="<?php czr_echo( 'attachment_class' ) ?>" title="<?php the_title_attribute(); ?>" rel="<?php czr_echo( 'link_rel' ) ?>"><?php echo wp_get_attachment_image( get_the_ID(), czr_get( 'attachment_size' ) ) ?></a>
