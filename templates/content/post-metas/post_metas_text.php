...
<div class="entry-meta" <?php czr_fn_echo('element_attributes') ?>>
  ...
  <span class="pub-date"><?php czr_fn_echo( 'publication_date')  ?></span>
  <?php endif; ?>
  <?php if ( czr_fn_get( 'cat_list' ) ) : ?>
   <span class="w-cat"><?php _e( 'in', 'customizr' ) ?> <?php czr_fn_echo( 'cat_list', null, array('/') ) ?></span>
  <?php endif; ?>
  <?php if ( czr_fn_get( 'tag_list' ) ): ?>
   <span class="w-tags"><?php _e( 'tagged', 'customizr' ) ?> <?php czr_fn_echo( 'tag_list', null, array('/') ) ?></span>
  <?php endif; ?>
