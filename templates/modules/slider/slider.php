...
<div id="customizr-slider-<?php czr_fn_echo( 'id' ) ?>" class="section-slider <?php czr_fn_echo( 'element_class' ) ?>"<?php czr_fn_echo('element_attributes') ?>>
  ...
  <?php if ( czr_fn_get( 'has_controls' ) ) : ?>
        <div class="slider-nav">
          <span class="slider-control btn btn-skin-darkest-shaded inverted slider-prev <?php czr_fn_echo( 'left_control_class' ) ?> icn-left-open-big" tabindex="0"></span>
          <span class="slider-control btn btn-skin-darkest-shaded inverted slider-next <?php czr_fn_echo( 'right_control_class' ) ?> icn-right-open-big" tabindex="0"></span>
        </div>
  <?php endif ?>
