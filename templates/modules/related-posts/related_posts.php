  ...
  <header>
    ...
    <?php if ( $wp_query->post_count > 1 ) : ?>
      <div class="related-posts_nav">
        <span class="btn btn-inverted btn-light-border slider-prev slider-control disabled icn-left-open-big" title="<?php esc_attr_e('Previous related articles', 'customizr')?>" tabindex="0"></span>
        <span class="btn btn-inverted btn-light-border slider-next slider-control icn-right-open-big" title="<?php esc_attr_e('Next related articles', 'customizr')?>" tabindex="0"></span>
      </div>
    <?php endif ?>
  </header>
