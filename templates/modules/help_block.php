...
<<?php
  ...
  czr_echo( 'element_tag' )

?> class="tc-placeholder-wrap <?php czr_echo( 'element_class' ) ?>" <?php
  ...
  <?php
    ...
    czr_echo( 'help_message' );
  ?>
  </strong></p>
  <?php

    /* Print the secondary message: contains html */
    czr_echo( 'help_secondary_message' );
