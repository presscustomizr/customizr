...
<div id="footer-widget-area" class="container widget__wrapper" role="complementary">
  <div class="row widget__container">
    ...
    <?php
      $_footer_widgets  = apply_filters( 'tc_footer_widgets', CZR_cl_init::$instance -> footer_widgets );

      $class = $_footer_widgets ? 'col-md-' . 12/( count($_footer_widgets) + 1 ) : '';
      foreach ( $_footer_widgets as $key => $area ):
      ?>
        <div id="<?php echo $key; ?>" class="<?php echo 'footer_one' == $key ? 'col-md-6 about': $class ?> col-xs-12">
