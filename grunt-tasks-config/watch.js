module.exports = {
	...
	create_push_skin : {
		...
		tasks : ['gitinfo' , 'replace:readme', 'less:dev_common', 'less:dev_skin' , 'cssmin:dev_common', 'cssmin:dev_skin' , 'ftp_push:dev_common', 'ftp_push:dev_skin'],
	},
	front_js : {
	...
	admin_js : {
		...
		tasks : ['gitinfo' , 'replace:readme', 'jshint:those'],
	},
	admin_css : {
