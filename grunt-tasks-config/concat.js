module.exports = {
  ...
  front_js: {
      ...
      '<%= paths.front_js4 %>jquery-plugins/jqueryimgOriginalSizes.js',
      '<%= paths.front_js4 %>jquery-plugins/jqueryaddDropCap.js',
      '<%= paths.front_js4 %>jquery-plugins/jqueryimgSmartLoad.js',
      '<%= paths.front_js4 %>jquery-plugins/jqueryextLinks.js',
      '<%= paths.front_js4 %>jquery-plugins/jqueryCenterImages.js',
      '<%= paths.front_js4 %>jquery-plugins/jqueryParallax.js',
  ...
  czr4_front_main_fmk_js : {
    src: [
      '<%= paths.front_js4 %>fmk/_main_base_0_utilities.part.js',
      '<%= paths.front_js4 %>fmk/_main_base_1_fmk.part.js',
      '<%= paths.front_js4 %>fmk/_main_base_2_initialize.part.js',
      '<%= paths.front_js4 %>fmk/_main_browser_detect.part.js',
      '<%= paths.front_js4 %>fmk/_main_jquery_plugins.part.js',
      '<%= paths.front_js4 %>fmk/_main_slider.part.js',
      '<%= paths.front_js4 %>fmk/_main_userxp.part.js',
      '<%= paths.front_js4 %>fmk/_main_sticky_header.part.js',
      '<%= paths.front_js4 %>fmk/_main_sticky_footer.part.js',
      //'<%= paths.front_js4 %>fmk/_main_masonry.part.js',
      '<%= paths.front_js4 %>fmk/_main_side_nav.part.js',
      '<%= paths.front_js4 %>fmk/_main_dropdowns.part.js',
      '<%= paths.front_js4 %>fmk/_main_xfire.part.js',
      '<%= paths.front_js4 %>fmk/_various_former_hardcoded.part.js'
    ],
    dest: '<%= paths.front_js4 %>fmk/main.js',
  },
  czr4_front_js4: {
    src: [
      '<%= paths.front_js4 %>fmk/tc-js-params.js',
      '<%= paths.front_js4 %>fmk/oldBrowserCompat.js',
      '<%= paths.front_js4 %>vendors/custom-bootstrap.min.js',
      '<%= paths.front_js %>parts/underscore-min.js',
      '<%= paths.front_js4 %>jquery-plugins/jqueryimgOriginalSizes.js',
      '<%= paths.front_js4 %>jquery-plugins/jqueryaddDropCap.js',
      '<%= paths.front_js4 %>jquery-plugins/jqueryimgSmartLoad.js',
      ...
      '<%= paths.front_js4 %>jquery-plugins/jqueryCenterImages.js',
      '<%= paths.front_js4 %>jquery-plugins/jqueryParallax.js',
      '<%= paths.front_js4 %>fmk/requestAnimationFramePolyfill.js',
      '<%= paths.front_js4 %>fmk/matchMediaPolyfill.js',
      '<%= paths.front_js4 %>fmk/smoothScroll.js',
      '<%= paths.front_js4 %>fmk/outline.js',
      '<%= paths.front_js4 %>vendors/waypoints.js',
      '<%= paths.front_js4 %>vendors/vivus.min.js',
      '<%= paths.front_js4 %>vendors/jquery.mCustomScrollbar.min.js',
      '<%= paths.front_js4 %>vendors/jquery.magnific-popup.js',
      '<%= paths.front_js4 %>fmk/main.js'
    ],
    dest: '<%= paths.front_js4 %>tc-scripts.js',
  },
  czr_css : {
