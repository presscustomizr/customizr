...
<?php get_header() ?>
  ...
  <?php do_action('__before_main_wrapper'); ?>
    <?php /* thumbnail in single post */
      if ( czr_has('post_thumbnail') && '__before_main_wrapper' == CZR_cl_utils_thumbnails::$instance -> czr_get_single_thumbnail_position() ) { czr_render_template('content/singles/thumbnail_single', 'post_thumbnail'); }
    ?>
              ...
              <div id="content" class="<?php tc_article_container_class() ?>">
                <?php
                  if ( have_posts() ) {
                    while ( have_posts() ) {
                      the_post();
                      czr_render_template('content/singles/post_content');
                    }//endwhile;
                  }//endif;
                ?>
                <?php
