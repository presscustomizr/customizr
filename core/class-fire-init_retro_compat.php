...
/*
* Before v.4.0.16(2.0.23) 'tc_header_desktop_topbar' was a boolean that expressed
...
*
* Since v.4.0.16(2.0.24) it's a multichoice expressing where to display the topbar in different devices
* 'none' => do not display
...
function czr_fn_maybe_move_old_header_topbar_to_new( $theme_options ) {
    ...
    if ( isset( $theme_options[ 'tc_header_desktop_topbar' ] ) ) {
        ...
        $theme_options[ 'tc_header_show_topbar' ] = 0 === $_old_header_desktop_topbar ? 'none' : 'desktop';
    }
...
/*
* Before v.4.0.16(2.0.23) 'tc_social_in_header' was a boolean that expressed
...
function czr_fn_maybe_move_old_header_socials_to_new( $theme_options ) {
    ...
    if ( isset( $theme_options[ 'tc_social_in_header' ] ) ) {
        ...
        $theme_options[ 'tc_header_show_socials' ] = 0 === $_old_header_desktop_socials ? 'none' : 'desktop';
    }
