...
class TC_footer_model_class extends TC_Model {
  ...
  function tc_setup_children() {
    $children = array(
      ...
      //footer social
      array( 'hook' => is_rtl() ? '__colophon_three__' : '__colophon_one__', 'template' => 'modules/social_block', 'model_class' => array( 'parent' => 'modules/social_block', 'name' => 'footer/footer_social_block' ) ),
      //footer credits
