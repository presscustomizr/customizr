...
class CZR_topbar_wrapper_model_class extends CZR_Model {
    ...
    */
    function czr_fn_extend_params( $model = array() ) {
        ...
        */
        $_contact_info_visibility = esc_attr( czr_fn_opt( 'tc_header_show_contact_info' ) );

        switch ( $_contact_info_visibility ) :
          case 'desktop' : $_contact_info_class = array( 'hidden-md-down' );
                           break;
          case 'mobile'  : $_contact_info_class = array( 'hidden-lg-up' );
                           break;
          case 'none'    : $_contact_info_class = array( 'hidden' );
                           break;
          default        : $_contact_info_class = array();
        endswitch;
        ...
        */
        ...
        $model = array_merge( $model, array(
            'contact_info_class' => $_contact_info_class,
