...
class CZR_cl_woocommerce_cart_model_class extends CZR_cl_Model {
  ...
  */
  ...
  /*
  * parse tagline model before rendering to narrow it's width
  */
  function pre_rendering_view_tagline_cb( $tagline_model ) {
    $tagline_model -> element_class = str_replace('span7', 'span6', $tagline_model -> element_class );
  }
