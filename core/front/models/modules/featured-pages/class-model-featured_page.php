...
class CZR_cl_featured_page_model_class extends CZR_cl_Model {
  ...
  function czr_fn_setup_button_block( $fp_data, $fp_single_id ) {
    //button block
    $fp_button_text = apply_filters( 'tc_fp_button_text' , esc_attr( CZR_cl_utils::$inst->czr_fn_opt( 'tc_featured_page_button_text') ) , $fp_single_id );
    if ( $fp_button_text || CZR___::$instance -> czr_fn_is_customizing() ){
