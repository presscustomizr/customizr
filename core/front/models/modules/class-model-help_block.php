...
class TC_help_block_model_class extends TC_Model {
  ...
  */
  ...
  function tc_extend_params( $model = array() ) {
    $model[ 'help_title'  ]              = $this -> tc_get_the_help_title();
    $model[ 'help_message']              = $this -> tc_get_the_help_message();
    $model[ 'help_secondary_message']    = $this -> tc_get_the_help_secondary_message();
    $model[ 'help_block_data']           = array_filter( array(
        $this -> tc_get_the_data_notice_id() ? 'data-notice_id="' . $this->tc_get_the_data_notice_id() . '"' : '',
        $this -> tc_get_the_data_user_option() ? 'data-user_option="' . $this->tc_get_the_data_user_option() . '"' : ''
    ));
    return $model;
  }
  ...
  */
  function tc_is_notice_enabled() {
    return 'disabled' != get_transient( $this -> tc_get_the_notice_transient() );
  }
  ...
  */
  ...
  function tc_get_the_help_title() {
  ...
  function tc_get_the_data_user_option() {
    return $this -> data_user_option;
  }

  function tc_get_the_data_notice_id() {
    return $this -> data_notice_id;
  }

  function tc_get_the_notice_transient() {
    return "tc_{$this -> tc_get_the_data_notice_id()}";
  }
