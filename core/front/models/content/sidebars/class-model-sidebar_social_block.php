...
class CZR_cl_sidebar_social_block_model_class extends CZR_cl_social_block_model_class {
  ...
  * @override
  */
  function czr_get_socials_where( $model ) {
    $this -> where = strpos( $model['hook'], 'right' ) > 0 ? 'right-sidebar' : 'left-sidebar';
    parent::czr_get_socials_where( $model );
  }

  /*
  * @override
  */
  function czr_get_before_socials() {
    $_title = esc_attr( CZR_cl_utils::$inst->czr_opt( 'tc_social_in_sidebar_title') );
