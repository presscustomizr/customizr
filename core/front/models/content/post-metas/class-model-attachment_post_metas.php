...
class CZR_cl_attachment_post_metas_model_class extends CZR_cl_post_metas_model_class {
  ...
  /* PUBLIC GETTERS */
  public function czr_fn_get_attachment_width() {
    return $this -> czr_fn_get_meta( 'size', 'width' );
  }

  public function czr_fn_get_attachment_height() {
    return $this -> czr_fn_get_meta( 'size', 'height' );
  }


  public function czr_fn_get_attachment_parent_url() {
    return $this -> czr_fn_get_meta( 'parent', 'url' );
  }

  public function czr_fn_get_attachment_parent_title() {
    return $this -> czr_fn_get_meta( 'parent', 'title' );
  }

  public function czr_fn_get_attachment_size() {
    return $this -> czr_fn_get_attachment_width() && $this -> czr_fn_get_attachment_height();
  }


  public function czr_fn_meta_generate_size( $what ) {
  ...
  public function czr_fn_meta_generate_parent( $what ) {
    $parent = $this -> czr_fn_get_attachment_parent();
  ...
  /* Helpers */
  private function czr_fn_get_attachment_parent() {
    return $this -> czr_fn_get_meta( 'attachment_parent' );
  }

  public function czr_fn_meta_generate_attachment_parent() {
    global $post;
