  ...
  class TC_controllers {
    ...
    function __construct( $args = array() ) {
      ...
      $this -> controllers = array(
        'header' => array(
          'head', 'title', 'logo_wrapper', 'logo', 'sticky_logo', 'logo_title', 'tagline', 'mobile_tagline_wrapper', 'header_socials', 'reset_margin_top', 'favicon', 'menu', 'sidenav', 'navbar_menu', 'navbar_secondary_menu', 'menu_button', 'mobile_menu_button', 'sidenav_menu_button', 'sidenav_navbar_menu_button', 'joie'
        ),
        'content' => array(
