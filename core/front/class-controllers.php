  ...
  class TC_controllers {
    ...
    function __construct( $args = array() ) {
      ...
      $this -> controllers = array(
        ...
        'content' => array(
          '404', 'attachment', 'comments', 'headings', 'no_results', 'page', 'post', 'post_list', 'post_metas_button', 'post_metas_text', 'post_navigation', 'right_sidebar', 'left_sidebar', 'posts_list_headings', 'posts_list_description', 'posts_list_title', 'singular_article', 'singular_title', 'post_list_title' 
        ),
        'footer' => array(
