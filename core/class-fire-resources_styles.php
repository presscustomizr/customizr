...
if ( ! class_exists( 'CZR_resources_styles' ) ) :
    class CZR_resources_styles {
        ...
        function czr_fn_maybe_write_skin_inline_css( $_css ) {
            ...
            $skin_dark_color      = czr_fn_sass_darken( $skin_color, '20%' );
            $skin_darkest_color   = czr_fn_sass_darken( $skin_color, '50%' );
            $skin_light_color     = czr_fn_sass_lighten( $skin_color, '20%' );
            $skin_lightest_color  = czr_fn_sass_lighten( $skin_color, '50%' );
