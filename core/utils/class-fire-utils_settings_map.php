...
*/
    ...
    * @since Customizr 3.0
    */
    function czr_fn_get_customizer_map( $get_default = null ) {
    ...
    function czr_fn_comment_option_map( $get_default = null ) {
      return array(
              ...
              'tc_comment_bubble_color' => array(
                                'default'     => CZR_cl_utils_options::$inst -> czr_fn_user_started_before_version( '3.3.2' , '1.0.11' ) ? '#F00' : czr_fn_getskincolor(),
    ...
    function czr_fn_generates_socials( $_original_map ) {
      ...
      foreach ( $socials as $key => $data ) {
        ...
        $_new_map[$key]  = array(
                      ...
                      'sanitize_callback' => 'czr_fn_sanitize_' . $type,
                      'control'       => 'CZR_cl_controls' ,
