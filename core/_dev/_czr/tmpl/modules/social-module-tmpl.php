...
function czr_fn_print_social_tmpls() {
  ...
  <script type="text/html" id="tmpl-czr-module-social-pre-add-view-content">
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="select">
      ...
      <div class="czr-input">
        <select data-czrtype="social-icon"></select>
      </div>
    </div>
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text">
      ...
      <div class="czr-input">
        <input data-czrtype="social-link" type="text" value="" placeholder="<?php _e('http://...,mailto:...,...', 'customizr'); ?>"></input>
      </div>
  ...
  <script type="text/html" id="tmpl-czr-module-social-mod-opt">
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="number" data-transport="postMessage">
      ...
      <div class="czr-input">
        <input data-czrtype="social-size" type="number" step="1" min="5" value="{{ data['social-size'] }}" />
      </div>
    </div>
  </script>
  ...
  <script type="text/html" id="tmpl-czr-module-social-item-content">
    <!-- <div class="czr-sub-set">
      ...
      <div class="czr-input">
        <span data-czrtype="id">{{ data.id }}</span>
      </div>
    </div> -->
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="select">
    ...
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text">
      ...
      <div class="czr-input">
        <input data-czrtype="social-link" type="text" value="{{ data['social-link'] }}" placeholder="<?php _e('http://...,mailto:...,...', 'customizr'); ?>"></input>
      </div>
    ...
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="text">
      ...
      <div class="czr-input">
        <input data-czrtype="title" type="text" value="{{ data.title }}" placeholder="<?php _e('Enter a title', 'customizr'); ?>"></input>
      </div>
    ...
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?> width-100" data-input-type="color" data-transport="postMessage">
      ...
      <div class="czr-input">
        <input data-czrtype="social-color" type="text" value="{{ data['social-color'] }}"></input>
      </div>
    ...
    <div class="<?php echo $css_attr['sub_set_wrapper']; ?>" data-input-type="check">
      ...
      <div class="czr-input">
        <input data-czrtype="social-target" type="checkbox" {{ _checked }}></input>
      </div>
