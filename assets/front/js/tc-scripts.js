...
+function () {
  ...
  var Collapse = function ($) {
    ...
    var Selector = {
      ACTIVES: '.card > .show, .card > .czr-collapsing',
    ...
    var Collapse = function () {
      function Collapse(element, config) {
        ...
        this._triggerArray = $.makeArray($(Selector.DATA_TOGGLE+'[href="#' + element.id + '"],' + (Selector.DATA_TOGGLE+'[data-target="#' + element.id + '"]')));
      ...
      Collapse.prototype.hide = function hide() {
        ...
        if (this._isTransitioning) {
          throw new Error('czr Collapse is transitioning');
        }
      ...
      Collapse.prototype._getParent = function _getParent() {
        ...
        var selector = Selector.DATA_TOGGLE+'[data-parent="' + this._config.parent + '"]';
  ...
  var Tab = function ($) {
    ...
    var Selector = {
      ...
      DATA_TOGGLE: '[data-toggle="czr-tab"], [data-toggle="czr-pill"]',
