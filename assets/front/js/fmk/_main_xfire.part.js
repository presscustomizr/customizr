...
jQuery(function ($) {
  var toLoad = {
    ...
    Czr_UserExperience : [ 'variousHoverActions', 'smoothScroll', 'formFocusAction', 'variousHeaderActions', 'pluginsCompatibility', 'disableHoverOnScroll', 'headingsActions_test' ],
