...
(function($, czrapp) {
  var _methods =  {
    ...
    sideNavEventHandler : function( evt, evt_name ) {
      ...
      switch ( evt_name ) {
        ...
        case 'transitionend' :
           ...
           if ( this._is_translating() && evt.target == $('#tc-sn').get()[0] )
   ...
   //  }
     ...
     $( '[data-toggle="sidenav"]' ).toggleClass('collapsed');
    },
    ...
    ***********************************************/
    ...
    _set_offset_height : function() {
      var _offset = this._get_initial_offset(),
          winHeight    = 'undefined' === typeof window.innerHeight ? window.innerHeight : czrapp.$_window.height(),
          newMaxHeight = winHeight - this.$_sidenav_menu.offset().top + czrapp.$_window.scrollTop();

      this.$_sidenav.css('top', _offset );
      this.$_sidenav_menu.css('height' , newMaxHeight + 'px');
