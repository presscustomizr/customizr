 ...
 */
?>
<section class="tc-content <?php czr_fn_echo('element_class') ?>" <?php czr_fn_echo('element_attributes') ?> >
  ...
  <section class="entry-content <?php czr_fn_echo( 'content_class' ) ?>">
    <?php
      czr_fn_echo( 'post_list_content', null, array(__( 'Continue reading <span class="meta-nav">&rarr;</span>' , 'customizr' ) ) );
