...
if ( 'trackpingback' == czr_fn_get('type') ) :

?>
<li <?php comment_class() ?> id="li-comment-<?php comment_ID() ?>" <?php czr_fn_echo('element_attributes') ?>>
...
<li <?php comment_class() ?> id="li-comment-<?php comment_ID() ?>" <?php czr_fn_echo('element_attributes') ?>>
  <article id="comment-<?php comment_ID() ?>" class="comment">
    <div class="row-fluid">
      ...
      <?php endif; ?>
        <section class="comment-content comment"><?php czr_fn_echo( 'comment_text' ) ?></section>
      </div>
    </div>
  </article>
<?php endif;
