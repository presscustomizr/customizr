...
class TC_post {
   ...
   //Access any method or var of the class with classname::$instance -> var or method():
    ...
    function tc_post_selectors () {
        ...
        if ( 'page' == tc__f('__post_type') || !is_singular() )
          return;
      ...
      <header class="entry-header">
        ...
        <?php 
            ...
            ( comments_open() && get_comments_number() != 0 && !post_password_required() ) ? '<span class="comments-link">
                <a href="'.get_permalink().'#comments" title="'.__( 'Comment(s) on ' , 'customizr' ).get_the_title().'"><span '.$bubble_style.' class="fs1 icon-bubble"></span><span class="inner">'.get_comments_number().'</span></a>
            </span>' : '',
