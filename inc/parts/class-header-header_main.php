...
if ( ! class_exists( 'TC_header_main' ) ) :
    ...
    */
		function tc_write_header_inline_css( $_css ) {
	     ...
	     //STICKY HEADER
		    if ( 0 != esc_attr( tc__f( '__get_option' , 'tc_sticky_shrink_title_logo') ) || TC___::$instance -> tc_is_customizing() ) {
    ...
    function tc_use_sticky_logo(){
   	...
   	*/
		function tc_set_tagline_visibility($html) {
			...
			if ( TC___::$instance -> tc_is_customizing() && 0 == esc_attr( tc__f( '__get_option' , 'tc_show_tagline') ) )
