       ...
       */
        ...
        if( ( 'post-new.php' == $hook || 'post.php' == $hook || 'media.php' == $hook) )  {
            ...
            wp_enqueue_script( 'tc_ajax_slider' ,
                sprintf('%1$sassets/admin/js/tc_ajax_slider%2$s.js' , TC_BASE_URL, $_min_version ),
                array( 'jquery' ),
                true
            );
            ...
            wp_enqueue_style( 'iphonecheckcss' ,
                sprintf('%1$sassets/admin/css/iphonecheck%2$s.css' , TC_BASE_URL, $_min_version )
            );
            wp_enqueue_script( 'iphonecheck' ,

                sprintf('%1$sassets/admin/js/jqueryIphonecheck%2$s.js' , TC_BASE_URL, $_min_version ),
                array('jquery'),
                true
            );
            ...
            wp_enqueue_style( 'sortablecss' ,
                sprintf('%1$sassets/admin/css/tc_sortable%2$s.css' , TC_BASE_URL, $_min_version )
            );
           ...
           //Access the global $wp_version variable to see which version of WordPress is installed.
            ...
            if ( 3.5 <= $wp_version ){
                ...
                wp_enqueue_script( 'cp_demo-custom' ,
                    sprintf('%1$sassets/admin/js/color-picker%2$s.js' , TC_BASE_URL, $_min_version ),
