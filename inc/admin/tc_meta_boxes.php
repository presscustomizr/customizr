...
if ( ! function_exists( 'tc_post_meta_boxes' ) ) :
add_action( 'add_meta_boxes', 'tc_post_meta_boxes' );
/**
...
if ( ! function_exists( 'tc_post_layout_box' ) ) :
/**
...
if ( ! function_exists( 'tc_post_slider_box' ) ) :
/**
    ...
    function tc_post_slider_box( $post ) {
         ...
         <div class="meta-box-item-title">
          ...
          <div id="post_slider_infos">
            <?php tc_get_post_slider_infos($post -> ID); ?>
          </div>
        <?php
    }//end of function
endif;
...
if ( ! function_exists( 'tc_get_post_slider_infos' ) ) :
/**
                    ...
                    <div id="post_slider-warning-message" style="display:none;">
                      <div style="text-align:center">
                         <p>
                          ...
                          <br/>
                           <a class="button-secondary" id="delete-slider" href="#" title="<?php _e( 'Delete slider','customizr' ); ?>" onClick="javascript:window.parent.tb_remove()"><?php _e( 'Delete slider','cusotmizr' ); ?></a>
                      </div>
                    </div>
                  <?php  tc_show_slides ($current_post_slides,$current_attachement_id = null); ?>
              <?php endif; ?>
...
----------------------------------------------------------------
*/
if ( ! function_exists( 'tc_post_fields_save' ) ) :
add_action( 'save_post', 'tc_post_fields_save' );
/**
...
if ( ! function_exists( 'tc_attachment_meta_box' ) ) :
add_action( 'add_meta_boxes', 'tc_attachment_meta_box' );
/**
...
if ( ! function_exists( 'tc_attachment_slider_box' ) ) :
/**
 * Prints the slider box content 
 * @package Customizr
 * @since Customizr 2.0
 */
    function tc_attachment_slider_box( $post ) {
         ...
         <div id="tc_slider_list">
           <?php tc_get_attachment_slider_infos($post -> ID) ?>
         </div>
        <?php
    }
endif;
...
if ( ! function_exists( 'tc_get_attachment_slider_infos' ) ) :
/**
            ...
            <div class="meta-box-item-content">
              ...
              <?php
                if (isset($current_post_slides)) {
                  ...
                  tc_show_slides ($current_post_slides,$current_attachement_id);
                }
              ?>
...
if ( ! function_exists( 'tc_slide_save' ) ) :
add_action( 'edit_attachment', 'tc_slide_save' );
/**
...
if ( ! function_exists( 'tc_show_slides' ) ) :
/**
...
----------------------------------------------------------------
*/
if ( ! function_exists( 'tc_slider_ajax_save' ) ) :
/**
...
----------------------------------------------------------------
*/
if ( ! function_exists( 'tc_slider_cb' ) ) :
add_action('wp_ajax_tc_slider_action', 'tc_slider_cb');
/**
 ...
 */
   function tc_slider_cb() {
    ...
    if ( ! wp_verify_nonce( $nonce, 'tc-slider-check-nonce' ) )
      ...
      tc_slider_ajax_save($tc_post_id);
      ...
      if(isset($_POST['tc_post_type'])) {
        if($_POST['tc_post_type'] == 'post') {
          tc_get_post_slider_infos($tc_post_id);
        }
        else {
          tc_get_attachment_slider_infos($tc_post_id);
        }
      }
...
/*
----------------------------------------------------------------
 ENQUEUE NECESSARY SCRIPTS AND STYLESHEETS (post and attachment)
----------------------------------------------------------------
*/
...
if ( ! function_exists( 'tc_attachment_filter' ) ) :
/**
 ...
 */
    ...
    if (version_compare($wp_version, '3.5', '<') ) {
      add_filter( 'attachment_fields_to_edit', 'tc_attachment_filter', 11, 2 );
      add_filter( 'attachment_fields_to_save', 'tc_attachment_save_filter', 11, 2 );
    }

    function tc_attachment_filter($form_fields, $post = null) {
        tc_attachment_slider_box ($post);
         return $form_fields;
