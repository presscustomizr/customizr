      ...
      function tc_welcome_panel() {
          ...
          <?php if ( ! TC___::tc_is_pro() ) : ?>
            <div class="changelog">
                ...
                <div class="feature-section col three-col">
                  ...
                  <div class="last-feature col">
                    ...
                    <p class="tc-follow"><a href="<?php echo TC_WEBSITE.'blog' ?>" target="_blank"><img src="<?php echo TC_BASE_URL.'assets/admin/img/pc.png' ?>" alt="Press Customizr" /></a></p>
            ...
            <div id="extend" class="changelog">
              ...
              <div class="feature-section images-stagger-right">
                <a class="" title="<?php _e("Visit the extension's page",'customizr') ?>" href="<?php echo TC_WEBSITE ?>customizr-pro/" target="_blank"><img alt="Customizr'extensions" src="<?php echo TC_BASE_URL.'assets/admin/img/customizr-pro.png' ?>" class=""></a>
        ...
        <div id="showcase" class="changelog">
          ...
          <div class="feature-section images-stagger-left">
             <a class="" title="<?php _e('Visit the showcase','customizr') ?>" href="<?php echo TC_WEBSITE ?>customizr/showcase/" target="_blank"><img alt="Customizr Showcase" src="<?php echo TC_BASE_URL.'assets/admin/img/mu2.png' ?>" class=""></a>
