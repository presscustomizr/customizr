...
jQuery(function ($) {
    ...
    if ( 1 == _p.FancyBoxState && 'function' === typeof($.fn.fancybox) ) {
        console.log('TYPE OF FB' , typeof($.fn.fancybox));
