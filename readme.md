# Customizr v3.4.7 [![Build Status](https://travis-ci.org/Nikeo/customizr.svg?branch=fix-customizer-control-visibility-#242)](https://travis-ci.org/Nikeo/customizr)
