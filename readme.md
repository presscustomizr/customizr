# Customizr v3.4.33 [![Built with Grunt](https://cdn.gruntjs.com/builtwith.png)](http://gruntjs.com/)
...
* fixed : compatibility problems with plugins using the WP tinyMCE editor. Example : Black studio tinyM
